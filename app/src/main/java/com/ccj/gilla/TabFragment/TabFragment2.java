...
public class TabFragment2 extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLayout = view.findViewById(R.id.layout_tab_fragment_2);
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        try {
            ...
            //네트워크 문제
            Toast.makeText(getActivity(), "지오코더 서비스 불가", Toast.LENGTH_SHORT).show();
    ...
    private boolean checkPermission() {
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION);
